...
class TestPlayerRepository(TestCase):
    ...
    def test_add_player(self):
        self.repository.add(Player(1, 'John Doe', datetime(1985, 9, 22), datetime(2020, 9, 22)))
    ...
    def test_list_all_players(self):
        self.repository.add(Player(1, 'John Doe', datetime(1985, 9, 22), datetime(2020, 9, 22)))
        self.repository.add(Player(2, 'Jane Done', datetime(1985, 9, 22), datetime(2020, 9, 22)))
