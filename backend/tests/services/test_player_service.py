...
class TestPlayerService(TestCase):
    ...
    def test_add_player(self):
        self.service.add_player(Player(1, 'John Doe', datetime(1985, 9, 22), '0', datetime(2020, 9, 22)))
    ...
    def test_list_all_players(self):
        self.service.add_player(Player(1, 'John Doe', datetime(1985, 9, 22), '0', datetime(2020, 9, 22)))
        self.service.add_player(Player(2, 'Jane Done', datetime(1985, 9, 22), '0', datetime(2020, 9, 22)))
    ...
    def test_list_all_players_by_year_of_birth(self):
        self.service.add_player(Player(1, 'John Doe', datetime(1985, 9, 22), '0', datetime(2020, 9, 22)))
        self.service.add_player(Player(2, 'Jane Done', datetime(1985, 9, 22), '0', datetime(2020, 9, 22)))
        self.service.add_player(Player(3, 'John Doe', datetime(1986, 9, 22), '0', datetime(2020, 9, 22)))
